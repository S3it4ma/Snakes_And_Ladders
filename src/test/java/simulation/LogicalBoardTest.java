...
class LogicalBoardTest {
    ...
    void translate() {
        ...
        LogicalBoard logicalBoard = new LogicalBoard(validator, null, textArea);
        Simulation s = logicalBoard.translate();
        assertTrue(s != null && !(s instanceof DeckSimulation) && !(s instanceof SimulationDecorator));
    }
}